...
export const SEED_MODELS: Model[] = [
  { id: 'llama31-8b', name: 'Llama 3.1 8B Instruct', total_params_b: 8.03, active_params_b: 8.03, layers: 32, kv_heads: 8, head_dim: 128, mla: false, max_ctx: 131072, tp_options: [1, 2, 4], quants: ['FP16', 'FP8', 'INT4', 'Q8_0', 'Q4_K_M'], hidden_size: 4096, vocab_size: 128256, tied_embeddings: false },
  { id: 'gptoss-20b', name: 'GPT-OSS 20B (MoE 3.6B act)', total_params_b: 21, active_params_b: 3.6, layers: 24, kv_heads: 8, head_dim: 64, mla: false, max_ctx: 131072, tp_options: [1, 2, 4], quants: ['MXFP4'], hidden_size: 2880, vocab_size: 201088, tied_embeddings: false, sliding_window: 128, full_attention_layers: 12 },
  ...
  { id: 'llama33-70b', name: 'Llama 3.3 70B Instruct', total_params_b: 70.6, active_params_b: 70.6, layers: 80, kv_heads: 8, head_dim: 128, mla: false, max_ctx: 131072, tp_options: [1, 2, 4, 8], quants: ['FP16', 'FP8', 'INT4', 'Q4_K_M', 'IQ4_XS'], hidden_size: 8192, vocab_size: 128256, tied_embeddings: false },
