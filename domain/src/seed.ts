...
export const SEED_MODELS: Model[] = [
  ...
  { id: 'glm52', name: 'GLM-5.2 743B-A39B (MoE·MLA·DSA)', total_params_b: 743, active_params_b: 39, layers: 78, kv_heads: 0, head_dim: 0, mla: true, max_ctx: 1048576, tp_options: [2, 4, 8, 16], quants: ['FP16', 'FP8', 'MXFP4', 'NVFP4'], hidden_size: 6144, intermediate_size: 18432, vocab_size: 154880, tied_embeddings: false, dense_params_b: 16.5, mixed_precision: { NVFP4: 'FP16' } },
  { id: 'dsv3', name: 'DeepSeek-V3 / R1 671B (MLA)', total_params_b: 671, active_params_b: 37, layers: 61, kv_heads: 0, head_dim: 0, mla: true, max_ctx: 131072, tp_options: [2, 4, 8, 16], quants: ['FP8', 'INT4'], hidden_size: 7168, intermediate_size: 18432, vocab_size: 129280, tied_embeddings: false },
  { id: 'kimi-k2', name: 'Kimi K2 1T-A32B (MLA)', total_params_b: 1026, active_params_b: 32.5, layers: 61, kv_heads: 0, head_dim: 0, mla: true, max_ctx: 131072, tp_options: [4, 8, 16], quants: ['FP8', 'INT4'], hidden_size: 7168, intermediate_size: 18432, vocab_size: 163840, tied_embeddings: false, dense_params_b: 9.4 },
  ...
  { id: 'kimi-k3', name: 'Kimi K3 2.8T-A60B (MoE·MLA+KDA)', total_params_b: 2800, active_params_b: 60, layers: 93, kv_heads: 0, head_dim: 0, mla: true, max_ctx: 1048576, tp_options: [8, 16], quants: ['MXFP4'], hidden_size: 7168, intermediate_size: 55296, vocab_size: 163840, tied_embeddings: false, full_attention_layers: 24, linear_attention_layers: 69, linear_state_bytes_per_layer: 6291456, dense_params_b: 20.8 },
];
