...
export const SEED_MODELS: Model[] = [
  { id: 'llama31-8b', name: 'Llama 3.1 8B Instruct', total_params_b: 8.03, active_params_b: 8.03, layers: 32, kv_heads: 8, head_dim: 128, mla: false, max_ctx: 131072, tp_options: [1, 2], quants: ['FP16', 'FP8', 'INT4'], hidden_size: 4096, vocab_size: 128256, tied_embeddings: false },
  { id: 'gptoss-20b', name: 'GPT-OSS 20B (MoE 3.6B act)', total_params_b: 21, active_params_b: 3.6, layers: 24, kv_heads: 8, head_dim: 64, mla: false, max_ctx: 131072, tp_options: [1, 2], quants: ['MXFP4'], hidden_size: 2880, vocab_size: 201088, tied_embeddings: false },
  { id: 'mistral-s24', name: 'Mistral Small 3.2 24B', total_params_b: 24, active_params_b: 24, layers: 40, kv_heads: 8, head_dim: 128, mla: false, max_ctx: 131072, tp_options: [1, 2, 4], quants: ['FP16', 'FP8', 'INT4'], hidden_size: 5120, vocab_size: 131072, tied_embeddings: false },
  ...
  { id: 'qwen3-32b', name: 'Qwen3-32B (dense)', total_params_b: 32.8, active_params_b: 32.8, layers: 64, kv_heads: 8, head_dim: 128, mla: false, max_ctx: 131072, tp_options: [1, 2, 4], quants: ['FP16', 'FP8', 'INT4'], hidden_size: 5120, vocab_size: 151936, tied_embeddings: false },
  { id: 'llama33-70b', name: 'Llama 3.3 70B Instruct', total_params_b: 70.6, active_params_b: 70.6, layers: 80, kv_heads: 8, head_dim: 128, mla: false, max_ctx: 131072, tp_options: [2, 4, 8], quants: ['FP16', 'FP8', 'INT4'], hidden_size: 8192, vocab_size: 128256, tied_embeddings: false },
  ...
  { id: 'gptoss-120b', name: 'GPT-OSS 120B (MoE 5.1B act)', total_params_b: 117, active_params_b: 5.1, layers: 36, kv_heads: 8, head_dim: 64, mla: false, max_ctx: 131072, tp_options: [1, 2, 4], quants: ['MXFP4'], hidden_size: 2880, vocab_size: 201088, tied_embeddings: false },
