...
- **Local/global attention** — models that alternate full-attention and sliding-window layers (GPT-OSS, Gemma, Mistral v0.1) only grow KV on the full-attention layers. For GPT-OSS-120B at 128K that halves the cache, 5.4 → 2.7 GiB per request.
